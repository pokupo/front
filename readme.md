...
1. `git clone https://github.com/pokupo/front.git pokupo` - cкачать в папку pokupo.
2. `cd pokupo` - переходим в папку проекта
...
--- | ---
`app` | Исходники.
`dist` | Скомпилированные файлы проекта. Открывается по адресу: [http://127.0.0.1:3000](http://127.0.0.1:3000).
